/* Hardware-independent evaluation for the acquisition IO2-to-TA0CCR4 acceptance test.
...
#ifndef USAC_LOOPBACK_H
#define USAC_LOOPBACK_H

#include <stdint.h>

#define USAC_LOOPBACK_EDGE_COUNT 8u

#define USAC_LOOPBACK_PASS 0x01u
#define USAC_LOOPBACK_COV_SEEN 0x02u
#define USAC_LOOPBACK_TIMEOUT 0x04u
#define USAC_LOOPBACK_INTERVAL_MISMATCH 0x08u
#define USAC_LOOPBACK_FINAL_NOT_HIGH 0x10u
#define USAC_LOOPBACK_PREPOST_SAFETY_FAILED 0x20u

typedef struct {
    uint16_t capture_ticks[USAC_LOOPBACK_EDGE_COUNT];
