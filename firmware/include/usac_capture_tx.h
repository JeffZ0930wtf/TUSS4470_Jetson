...
#ifndef USAC_CAPTURE_TX_H
#define USAC_CAPTURE_TX_H
...
typedef enum {
    USAC_CAPTURE_TX_IDLE = 0,
    USAC_CAPTURE_TX_READY = 1,
    USAC_CAPTURE_TX_IN_FLIGHT = 2,
    USAC_CAPTURE_TX_COMPLETE = 3,
    USAC_CAPTURE_TX_FAILED = 4
} usac_capture_tx_state_t;

typedef enum {
    USAC_CAPTURE_TX_START_STARTED = 0,
    USAC_CAPTURE_TX_START_BUSY = 1,
    USAC_CAPTURE_TX_START_FATAL = 2
} usac_capture_tx_start_result_t;

typedef struct {
    usac_capture_stream_t *stream;
    usac_capture_tx_state_t state;
} usac_capture_tx_t;
