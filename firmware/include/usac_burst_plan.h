/* Pure V1 Burst planning.  This module validates a requested finite Burst and
 * describes which TUSS4470 control path the MSP430 platform must drive; it
 * never touches GPIO, SPI, timers, or the transducer. */
#ifndef USAC_BURST_PLAN_H
#define USAC_BURST_PLAN_H

#include <stdint.h>

#define USAC_BURST_USE_CMD_TRIGGER 0x01u
#define USAC_BURST_USE_IO1_ENABLE 0x02u
#define USAC_BURST_USE_IO1_TIMER 0x04u
#define USAC_BURST_USE_IO2_TIMER 0x08u
#define USAC_BURST_NONOVERLAP 0x10u
