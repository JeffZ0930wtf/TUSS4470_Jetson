...
#define USAC_CAPTURE_SAMPLE_COUNT 2048u
#define USAC_CAPTURE_DEFAULT_PRETRIGGER_COUNT 64u
#define USAC_MAX_CAPTURE_EVENTS 17u
...
#define USAC_CAPTURE_DIAG_GIE_AT_ENTRY 0x0001u
#define USAC_CAPTURE_DIAG_TB0_RUNNING 0x0002u
#define USAC_CAPTURE_DIAG_ADC_ENABLED 0x0004u
#define USAC_CAPTURE_DIAG_ADC_IFG0 0x0008u
#define USAC_CAPTURE_DIAG_DMA0_ENABLED 0x0010u
#define USAC_CAPTURE_DIAG_DMA0_IFG 0x0020u
#define USAC_CAPTURE_DIAG_DMA1_IFG 0x0040u
#define USAC_CAPTURE_DIAG_BURST_COMPLETE 0x0080u
...
} usac_capture_report_t;

extern uint16_t g_usac_capture_waveform[USAC_CAPTURE_SAMPLE_COUNT];
