...
function ensureCompatible(metadata) {
  ...
  if (metadata.capture_id === state.primaryCaptureId) return;
  if (!primary) throw new Error(t("waveform.primaryPending"));
